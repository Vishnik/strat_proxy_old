...
class Worker {
    ...
    #handleMessage(message) {
        ...
        if (method === 'mining.notify') {
            console.log('POOL: notify: jobId=', message.params[0]);
            message.params[message.params.length - 1] = true;
    ...
    #authorize()
    {
        const message = {
            ...
            params: [config.params.credentials.user, 'D=524288'],
            id: ++this.messageId,
        }
        this.socket.write(JSON.stringify(message) + '\n');
