...
class Worker {
    ...
    submitMessage(message) {
        ...
        this.socket.once('data', (data) => {
            ...
            console.log('POOL: Ответ на решение: ' + data);

            if (message.result) {
                console.log("POOL: ACCEPTED!");
            }
        });
    }
    ...
    #handleMessage(message) {
        ...
        if (method === 'mining.notify') {
            console.log('POOL: Добавили новый нотифай! ', JSON.stringify(message));
            this.messages.push(message);
            console.log('POOL: Добавили новый нотифай!', this.messages.length);
        } else if (method === 'mining.set_difficulty') {
            this.messages.length = 0;
            this.difficult = message.params[0];
            console.log('POOL: установили сложность = ', message.params[0]);
            console.log('POOL: очистили список нотифаев');
        }
    }
